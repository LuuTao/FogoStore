...
interface Props {
  ...
  currentSlug: string;
  baseSlug: string;
  urlStorage: string; // Đối với Watch sẽ đóng vai trò là Size mặt (41mm, 45mm,...)
}
...
export default function WatchDetail({
  ...
  useEffect(() => {
    ...
    // Tự động tìm size từ URL hoặc biến thể đầu tiên (Mặc định 41mm / 45mm / 46mm)
  ...
  // Danh sách kích thước mặt có sẵn của sản phẩm
  ...
  // Kiểm tra tình trạng hàng theo từng Size
      ...
      <div>
        ...
        <div className="w-full bg-[#f8f9fa] border-b border-gray-200 py-2 px-4 text-[11px] text-gray-600">
          <div className="max-w-7xl mx-auto flex items-center gap-1.5 truncate">
            ...
            <span>/</span>
            <span className="text-gray-900 font-semibold">{cleanProductName} {selectedSize}</span>
          </div>
        </div>
        ...
        <main className="max-w-7xl mx-auto px-4 py-6">
            ...
            <div className="lg:col-span-7 space-y-4 text-xs">
              <div>
                ...
                <div className="flex items-center gap-1 text-amber-400 mt-1">
                  ...
                  <span className="text-[11px] text-gray-500 ml-1">Đo nhịp tim, ECG &amp; Kháng nước 50m</span>
                </div>
              </div>
              ...
              {/* Chọn kích thước mặt (Size) */}
              <div className="space-y-1.5 pt-2">
                <span className="font-semibold text-gray-700 flex items-center gap-1">
                  <WatchIcon size={14} className="text-[#d70018]" />
                  <span>Chọn kích thước mặt đồng hồ:</span>
                </span>
              ...
              {/* Chọn màu sắc và dây đeo */}
              <div className="space-y-1.5 pt-2">
                <span className="font-semibold text-gray-700">Màu sắc &amp; Kiểu dây:</span>
              ...
              {/* Banner Ưu đãi Dây đeo Apple Watch */}
              <div className="bg-gradient-to-r from-[#e056fd] to-[#686de0] text-white p-3 rounded-sm flex items-center justify-between mt-2">
                <span className="font-bold text-xs">Giảm ngay 150.000đ khi mua thêm Dây đeo thể thao hoặc Dây Milanese</span>
          ...
          {/* Bài viết tính năng Apple Watch */}
          ...
          {relatedProducts.length > 0 && (
            <div className="mt-12">
              <h3 className="text-base font-black text-gray-900 uppercase tracking-wide mb-4 flex items-center gap-2">
                ...
                <span>Các Dòng Apple Watch Khác Cùng Quan Tâm</span>
              </h3>
                  ...
                  return (
                    <div key={rel.id} className="bg-white rounded-sm p-3 flex flex-col justify-between shadow-xs border border-gray-200">
                      <Link href={`/san-pham/${rel.slug}`} className="w-full h-36 flex items-center justify-center p-2">
                        <img
                          src={v.images?.[0] || 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=300'}
                          alt={rel.name}

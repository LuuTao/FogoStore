...
export default function AccessoryDetail({
  ...
  useEffect(() => {
    ...
    const activeSt = (urlStorage || firstValidVar?.storage || '').trim();
    setSelectedStorage(activeSt.toUpperCase() === 'TIÊU CHUẨN' ? '' : activeSt);
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-4 w-full">
              ...
              {/* CHỌN PHÂN LOẠI / KÍCH CỠ: TỰ ĐỘNG XUỐNG DÒNG VÀ SÁNG VIỀN ĐỎ */}
          ...
          {/* CÁC SẢN PHẨM PHỤ KIỆN KHÁC CÙNG QUAN TÂM */}

...
const MACBOOK_SERIES_TABS = [
  ...
  },
  {
    ...
    series: 'pro',
    name: 'MacBook Pro',
    imageUrl: 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=100',
  },
  {
    id: 'air',
    series: 'air',
    name: 'MacBook Air',
    imageUrl: 'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=100',
  },
  {
    id: 'neo',
    series: 'neo',
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 mt-12 select-none">
      ...
      <div className="bg-[#fff9f1] border border-[#fbe9d2] rounded-md p-5 md:p-8 shadow-sm">
        ...
        <div className="flex items-center justify-center gap-8 md:gap-16 mb-8 overflow-x-auto pb-2 scrollbar-none">

      ...
      <div>
        ...
        <div className="w-full bg-[#f8f9fa] border-b border-gray-200 py-2.5 px-4 text-xs">
          <div className="max-w-7xl mx-auto flex items-center gap-1.5 text-gray-600">
            <Link href="/" className="hover:text-[#d70018] transition-colors">
              Trang chủ
            </Link>
            <span>/</span>
            <span className="text-gray-900 font-bold">Tin tức</span>
          </div>
        </div>

        {/* KHUNG NỘI DUNG CHÍNH (max-w-7xl mx-auto px-4 py-6) */}
        <main className="max-w-7xl mx-auto px-4 py-6">
          <h1 className="text-xl md:text-2xl font-black text-gray-900 mb-6">
            Tin tức
          </h1>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            {/* CỘT TRÁI: DANH SÁCH BÀI VIẾT (8 CỘT) */}
            <div className="lg:col-span-8">
              {loading ? (
                ...
                <div className="py-20 text-center bg-gray-50 rounded-xl border border-gray-200 p-8 shadow-xs">
            ...
            <div className="lg:col-span-4 space-y-6 sticky top-24">
              {/* WIDGET 1: BÀI VIẾT MỚI NHẤT (4 BÀI + XEM THÊM KẾ BÊN) */}
